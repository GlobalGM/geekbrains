...
print("Создаем спортивный автомобиль truckCar2")
let truckCar2 = truckCar (trailer: false)
print("Количество выпущенных автомобилей: \(Car.carCount)\n")

print("Кнопка оцепить цестерну")
truckCar1.openTrailer()
print ("Наличие закрепленной цестерны \(truckCar1.trailer) у автомобиля truckCar1")
print("----")
print("Кнопка приципить цестерну")
truckCar1.closeTrailer()
print ("Наличие закрепленной цестерны \(truckCar1.trailer) у автомобиля truckCar1")
